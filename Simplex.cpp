  ...
  void Data()
   {
    ...
    char R;
    int I,J;
    printf("Maximize Economic Function(Y/N)? ");
    scanf("%c", &R);
    printf("\nEnter the number of variables in the economic function :\n ");
    scanf("%d", &NV);
    ...
    if (R == 'Y' || R=='y')
      ...
      R1 = -1.0;
    printf("\nEnter the Coeffecients for the Economic Function:\n");
    for (J = 1; J<=NV; J++)
    {
      printf("       #%d ? ", J);
	  scanf("%lf", &R2);
